...
var Annotation = function($__super) {
  function Annotation(location, name, args) {
    $__superConstructor(Annotation).call(this, location);
    this.name = name;
    this.args = args;
  }
  return ($__createClass)(Annotation, {
...
var AnonBlock = function($__super) {
  function AnonBlock(location, statements) {
    $__superConstructor(AnonBlock).call(this, location);
    this.statements = statements;
  }
  return ($__createClass)(AnonBlock, {
    transform: function(transformer) {
...
var ArgumentList = function($__super) {
  function ArgumentList(location, args) {
    $__superConstructor(ArgumentList).call(this, location);
    this.args = args;
  }
  return ($__createClass)(ArgumentList, {
    transform: function(transformer) {
...
var ArrayComprehension = function($__super) {
  function ArrayComprehension(location, comprehensionList, expression) {
    $__superConstructor(ArrayComprehension).call(this, location);
    this.comprehensionList = comprehensionList;
    this.expression = expression;
  }
  return ($__createClass)(ArrayComprehension, {
    transform: function(transformer) {
...
var ArrayLiteral = function($__super) {
  function ArrayLiteral(location, elements) {
    $__superConstructor(ArrayLiteral).call(this, location);
    this.elements = elements;
  }
  return ($__createClass)(ArrayLiteral, {
    transform: function(transformer) {
...
var ArrayPattern = function($__super) {
  function ArrayPattern(location, elements) {
    $__superConstructor(ArrayPattern).call(this, location);
    this.elements = elements;
  }
  return ($__createClass)(ArrayPattern, {
    transform: function(transformer) {
...
var ArrayType = function($__super) {
  function ArrayType(location, elementType) {
    $__superConstructor(ArrayType).call(this, location);
    this.elementType = elementType;
  }
  return ($__createClass)(ArrayType, {
    transform: function(transformer) {
...
var ArrowFunction = function($__super) {
  function ArrowFunction(location, functionKind, parameterList, body) {
    $__superConstructor(ArrowFunction).call(this, location);
    this.functionKind = functionKind;
    this.parameterList = parameterList;
    this.body = body;
  }
  return ($__createClass)(ArrowFunction, {
    transform: function(transformer) {
...
var AssignmentElement = function($__super) {
  function AssignmentElement(location, assignment, initializer) {
    $__superConstructor(AssignmentElement).call(this, location);
    this.assignment = assignment;
    this.initializer = initializer;
  }
  return ($__createClass)(AssignmentElement, {
    transform: function(transformer) {
...
var AwaitExpression = function($__super) {
  function AwaitExpression(location, expression) {
    $__superConstructor(AwaitExpression).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(AwaitExpression, {
    transform: function(transformer) {
...
var BinaryExpression = function($__super) {
  function BinaryExpression(location, left, operator, right) {
    $__superConstructor(BinaryExpression).call(this, location);
    this.left = left;
    this.operator = operator;
    this.right = right;
  }
  return ($__createClass)(BinaryExpression, {
    transform: function(transformer) {
...
var BindingElement = function($__super) {
  function BindingElement(location, binding, initializer) {
    $__superConstructor(BindingElement).call(this, location);
    this.binding = binding;
    this.initializer = initializer;
  }
  return ($__createClass)(BindingElement, {
    transform: function(transformer) {
...
var BindingIdentifier = function($__super) {
  function BindingIdentifier(location, identifierToken) {
    $__superConstructor(BindingIdentifier).call(this, location);
    this.identifierToken = identifierToken;
  }
  return ($__createClass)(BindingIdentifier, {
    transform: function(transformer) {
...
var Block = function($__super) {
  function Block(location, statements) {
    $__superConstructor(Block).call(this, location);
    this.statements = statements;
  }
  return ($__createClass)(Block, {
    transform: function(transformer) {
...
var BreakStatement = function($__super) {
  function BreakStatement(location, name) {
    $__superConstructor(BreakStatement).call(this, location);
    this.name = name;
  }
  return ($__createClass)(BreakStatement, {
    transform: function(transformer) {
...
var CallExpression = function($__super) {
  function CallExpression(location, operand, args) {
    $__superConstructor(CallExpression).call(this, location);
    this.operand = operand;
    this.args = args;
  }
  return ($__createClass)(CallExpression, {
    transform: function(transformer) {
...
var CallSignature = function($__super) {
  function CallSignature(location, typeParameters, parameterList, returnType) {
    $__superConstructor(CallSignature).call(this, location);
    this.typeParameters = typeParameters;
    this.parameterList = parameterList;
    this.returnType = returnType;
  }
  return ($__createClass)(CallSignature, {
    transform: function(transformer) {
...
var CaseClause = function($__super) {
  function CaseClause(location, expression, statements) {
    $__superConstructor(CaseClause).call(this, location);
    this.expression = expression;
    this.statements = statements;
  }
  return ($__createClass)(CaseClause, {
    transform: function(transformer) {
...
var Catch = function($__super) {
  function Catch(location, binding, catchBody) {
    $__superConstructor(Catch).call(this, location);
    this.binding = binding;
    this.catchBody = catchBody;
  }
  return ($__createClass)(Catch, {
    transform: function(transformer) {
...
var ClassDeclaration = function($__super) {
  function ClassDeclaration(location, name, superClass, elements, annotations, typeParameters) {
    $__superConstructor(ClassDeclaration).call(this, location);
    this.name = name;
  ...
  return ($__createClass)(ClassDeclaration, {
    transform: function(transformer) {
...
var ClassExpression = function($__super) {
  function ClassExpression(location, name, superClass, elements, annotations, typeParameters) {
    $__superConstructor(ClassExpression).call(this, location);
    this.name = name;
    this.superClass = superClass;
    this.elements = elements;
    this.annotations = annotations;
  ...
  return ($__createClass)(ClassExpression, {
    transform: function(transformer) {
...
var CommaExpression = function($__super) {
  function CommaExpression(location, expressions) {
    $__superConstructor(CommaExpression).call(this, location);
    this.expressions = expressions;
  }
  return ($__createClass)(CommaExpression, {
    transform: function(transformer) {
...
var ComprehensionFor = function($__super) {
  function ComprehensionFor(location, left, iterator) {
    $__superConstructor(ComprehensionFor).call(this, location);
    this.left = left;
...
var ComprehensionIf = function($__super) {
  function ComprehensionIf(location, expression) {
    $__superConstructor(ComprehensionIf).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ComprehensionIf, {
    transform: function(transformer) {
...
var ComputedPropertyName = function($__super) {
  function ComputedPropertyName(location, expression) {
    $__superConstructor(ComputedPropertyName).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ComputedPropertyName, {
    transform: function(transformer) {
...
var ConditionalExpression = function($__super) {
  function ConditionalExpression(location, condition, left, right) {
    $__superConstructor(ConditionalExpression).call(this, location);
    this.condition = condition;
    this.left = left;
    this.right = right;
  }
  return ($__createClass)(ConditionalExpression, {
    transform: function(transformer) {
...
var ConstructSignature = function($__super) {
  function ConstructSignature(location, typeParameters, parameterList, returnType) {
    $__superConstructor(ConstructSignature).call(this, location);
    this.typeParameters = typeParameters;
    this.parameterList = parameterList;
    this.returnType = returnType;
  }
  return ($__createClass)(ConstructSignature, {
    transform: function(transformer) {
...
var ConstructorType = function($__super) {
  function ConstructorType(location, typeParameters, parameterList, returnType) {
    $__superConstructor(ConstructorType).call(this, location);
    this.typeParameters = typeParameters;
    this.parameterList = parameterList;
    this.returnType = returnType;
  }
  return ($__createClass)(ConstructorType, {
    transform: function(transformer) {
...
var ContinueStatement = function($__super) {
  function ContinueStatement(location, name) {
    $__superConstructor(ContinueStatement).call(this, location);
    this.name = name;
  }
  return ($__createClass)(ContinueStatement, {
    transform: function(transformer) {
...
var CoverFormals = function($__super) {
  function CoverFormals(location, expressions) {
    $__superConstructor(CoverFormals).call(this, location);
    this.expressions = expressions;
  }
  return ($__createClass)(CoverFormals, {
    transform: function(transformer) {
...
var CoverInitializedName = function($__super) {
  function CoverInitializedName(location, name, equalToken, initializer) {
    $__superConstructor(CoverInitializedName).call(this, location);
    this.name = name;
    this.equalToken = equalToken;
    this.initializer = initializer;
  }
  return ($__createClass)(CoverInitializedName, {
    transform: function(transformer) {
...
var DebuggerStatement = function($__super) {
  function DebuggerStatement(location) {
    $__superConstructor(DebuggerStatement).call(this, location);
  }
  return ($__createClass)(DebuggerStatement, {
    transform: function(transformer) {
...
var DefaultClause = function($__super) {
  function DefaultClause(location, statements) {
    $__superConstructor(DefaultClause).call(this, location);
    this.statements = statements;
  }
  return ($__createClass)(DefaultClause, {
    transform: function(transformer) {
...
var DoWhileStatement = function($__super) {
  function DoWhileStatement(location, body, condition) {
    $__superConstructor(DoWhileStatement).call(this, location);
    this.body = body;
    this.condition = condition;
  }
  return ($__createClass)(DoWhileStatement, {
    transform: function(transformer) {
...
var EmptyStatement = function($__super) {
  function EmptyStatement(location) {
    $__superConstructor(EmptyStatement).call(this, location);
  }
  return ($__createClass)(EmptyStatement, {
    transform: function(transformer) {
...
var ExportDeclaration = function($__super) {
  function ExportDeclaration(location, declaration, annotations) {
    $__superConstructor(ExportDeclaration).call(this, location);
    this.declaration = declaration;
    this.annotations = annotations;
  }
  return ($__createClass)(ExportDeclaration, {
    transform: function(transformer) {
...
var ExportDefault = function($__super) {
  function ExportDefault(location, expression) {
    $__superConstructor(ExportDefault).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ExportDefault, {
    transform: function(transformer) {
...
var ExportSpecifier = function($__super) {
  function ExportSpecifier(location, lhs, rhs) {
    $__superConstructor(ExportSpecifier).call(this, location);
    this.lhs = lhs;
    this.rhs = rhs;
  }
  return ($__createClass)(ExportSpecifier, {
    transform: function(transformer) {
...
var ExportSpecifierSet = function($__super) {
  function ExportSpecifierSet(location, specifiers) {
    $__superConstructor(ExportSpecifierSet).call(this, location);
    this.specifiers = specifiers;
  }
  return ($__createClass)(ExportSpecifierSet, {
    transform: function(transformer) {
...
var ExportStar = function($__super) {
  function ExportStar(location) {
    $__superConstructor(ExportStar).call(this, location);
  }
  return ($__createClass)(ExportStar, {
    transform: function(transformer) {
...
var ExpressionStatement = function($__super) {
  function ExpressionStatement(location, expression) {
    $__superConstructor(ExpressionStatement).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ExpressionStatement, {
    transform: function(transformer) {
...
var Finally = function($__super) {
  function Finally(location, block) {
    $__superConstructor(Finally).call(this, location);
    this.block = block;
  }
  return ($__createClass)(Finally, {
    transform: function(transformer) {
...
var ForInStatement = function($__super) {
  function ForInStatement(location, initializer, collection, body) {
    $__superConstructor(ForInStatement).call(this, location);
    this.initializer = initializer;
    this.collection = collection;
    this.body = body;
  }
  return ($__createClass)(ForInStatement, {
    transform: function(transformer) {
...
var ForOfStatement = function($__super) {
  function ForOfStatement(location, initializer, collection, body) {
    $__superConstructor(ForOfStatement).call(this, location);
    this.initializer = initializer;
    this.collection = collection;
    this.body = body;
  }
  return ($__createClass)(ForOfStatement, {
    transform: function(transformer) {
...
var ForOnStatement = function($__super) {
  function ForOnStatement(location, initializer, observable, body) {
    $__superConstructor(ForOnStatement).call(this, location);
    this.initializer = initializer;
    this.observable = observable;
    this.body = body;
  }
  return ($__createClass)(ForOnStatement, {
    transform: function(transformer) {
...
var ForStatement = function($__super) {
  function ForStatement(location, initializer, condition, increment, body) {
    $__superConstructor(ForStatement).call(this, location);
    this.initializer = initializer;
    this.condition = condition;
    this.increment = increment;
    this.body = body;
  }
  return ($__createClass)(ForStatement, {
    transform: function(transformer) {
...
var FormalParameter = function($__super) {
  function FormalParameter(location, parameter, typeAnnotation, annotations) {
    $__superConstructor(FormalParameter).call(this, location);
    this.parameter = parameter;
    this.typeAnnotation = typeAnnotation;
    this.annotations = annotations;
  }
  return ($__createClass)(FormalParameter, {
    transform: function(transformer) {
...
var FormalParameterList = function($__super) {
  function FormalParameterList(location, parameters) {
    $__superConstructor(FormalParameterList).call(this, location);
    this.parameters = parameters;
  }
  return ($__createClass)(FormalParameterList, {
    transform: function(transformer) {
...
var ForwardDefaultExport = function($__super) {
  function ForwardDefaultExport(location, name) {
    $__superConstructor(ForwardDefaultExport).call(this, location);
    this.name = name;
  }
  return ($__createClass)(ForwardDefaultExport, {
    transform: function(transformer) {
...
var FunctionBody = function($__super) {
  function FunctionBody(location, statements) {
    $__superConstructor(FunctionBody).call(this, location);
    this.statements = statements;
  }
  return ($__createClass)(FunctionBody, {
    transform: function(transformer) {
...
var FunctionDeclaration = function($__super) {
  function FunctionDeclaration(location, name, functionKind, parameterList, typeAnnotation, annotations, body) {
    $__superConstructor(FunctionDeclaration).call(this, location);
    this.name = name;
    this.functionKind = functionKind;
    this.parameterList = parameterList;
    this.typeAnnotation = typeAnnotation;
  ...
  return ($__createClass)(FunctionDeclaration, {
    transform: function(transformer) {
...
var FunctionExpression = function($__super) {
  function FunctionExpression(location, name, functionKind, parameterList, typeAnnotation, annotations, body) {
    $__superConstructor(FunctionExpression).call(this, location);
    this.name = name;
    this.functionKind = functionKind;
    this.parameterList = parameterList;
    this.typeAnnotation = typeAnnotation;
  ...
  return ($__createClass)(FunctionExpression, {
    transform: function(transformer) {
...
var FunctionType = function($__super) {
  function FunctionType(location, typeParameters, parameterList, returnType) {
    $__superConstructor(FunctionType).call(this, location);
    this.typeParameters = typeParameters;
    this.parameterList = parameterList;
    this.returnType = returnType;
  }
  return ($__createClass)(FunctionType, {
    transform: function(transformer) {
...
var GeneratorComprehension = function($__super) {
  function GeneratorComprehension(location, comprehensionList, expression) {
    $__superConstructor(GeneratorComprehension).call(this, location);
    this.comprehensionList = comprehensionList;
    this.expression = expression;
  }
  return ($__createClass)(GeneratorComprehension, {
    transform: function(transformer) {
...
var GetAccessor = function($__super) {
  function GetAccessor(location, isStatic, name, typeAnnotation, annotations, body) {
    $__superConstructor(GetAccessor).call(this, location);
  ...
  return ($__createClass)(GetAccessor, {
    transform: function(transformer) {
...
var IdentifierExpression = function($__super) {
  function IdentifierExpression(location, identifierToken) {
    $__superConstructor(IdentifierExpression).call(this, location);
    this.identifierToken = identifierToken;
  }
  return ($__createClass)(IdentifierExpression, {
    transform: function(transformer) {
...
var IfStatement = function($__super) {
  function IfStatement(location, condition, ifClause, elseClause) {
    $__superConstructor(IfStatement).call(this, location);
    this.condition = condition;
    this.ifClause = ifClause;
    this.elseClause = elseClause;
  }
  return ($__createClass)(IfStatement, {
    transform: function(transformer) {
...
var ImportedBinding = function($__super) {
  function ImportedBinding(location, binding) {
    $__superConstructor(ImportedBinding).call(this, location);
    this.binding = binding;
  }
  return ($__createClass)(ImportedBinding, {
    transform: function(transformer) {
...
var ImportClausePair = function($__super) {
  function ImportClausePair(location, first, second) {
    $__superConstructor(ImportClausePair).call(this, location);
    this.first = first;
    this.second = second;
  }
  return ($__createClass)(ImportClausePair, {
    transform: function(transformer) {
...
var ImportDeclaration = function($__super) {
  function ImportDeclaration(location, importClause, moduleSpecifier) {
    $__superConstructor(ImportDeclaration).call(this, location);
    this.importClause = importClause;
    this.moduleSpecifier = moduleSpecifier;
  }
  return ($__createClass)(ImportDeclaration, {
    transform: function(transformer) {
...
var ImportSpecifier = function($__super) {
  function ImportSpecifier(location, binding, name) {
    $__superConstructor(ImportSpecifier).call(this, location);
    this.binding = binding;
    this.name = name;
  }
  return ($__createClass)(ImportSpecifier, {
    transform: function(transformer) {
...
var ImportSpecifierSet = function($__super) {
  function ImportSpecifierSet(location, specifiers) {
    $__superConstructor(ImportSpecifierSet).call(this, location);
    this.specifiers = specifiers;
  }
  return ($__createClass)(ImportSpecifierSet, {
    transform: function(transformer) {
...
var ImportTypeClause = function($__super) {
  function ImportTypeClause(location, clause) {
    $__superConstructor(ImportTypeClause).call(this, location);
    this.clause = clause;
  }
  return ($__createClass)(ImportTypeClause, {
    transform: function(transformer) {
...
var IndexSignature = function($__super) {
  function IndexSignature(location, name, indexType, typeAnnotation) {
    $__superConstructor(IndexSignature).call(this, location);
    this.name = name;
    this.indexType = indexType;
    this.typeAnnotation = typeAnnotation;
  }
  return ($__createClass)(IndexSignature, {
    transform: function(transformer) {
...
var InterfaceDeclaration = function($__super) {
  function InterfaceDeclaration(location, name, typeParameters, extendsClause, objectType) {
    $__superConstructor(InterfaceDeclaration).call(this, location);
    this.name = name;
    this.typeParameters = typeParameters;
    this.extendsClause = extendsClause;
    this.objectType = objectType;
  }
  return ($__createClass)(InterfaceDeclaration, {
    transform: function(transformer) {
...
var JsxAttribute = function($__super) {
  function JsxAttribute(location, name, value) {
    $__superConstructor(JsxAttribute).call(this, location);
    this.name = name;
    this.value = value;
  }
  return ($__createClass)(JsxAttribute, {
    transform: function(transformer) {
...
var JsxElement = function($__super) {
  function JsxElement(location, name, attributes, children) {
    $__superConstructor(JsxElement).call(this, location);
    this.name = name;
    this.attributes = attributes;
    this.children = children;
  }
  return ($__createClass)(JsxElement, {
    transform: function(transformer) {
...
var JsxElementName = function($__super) {
  function JsxElementName(location, names) {
    $__superConstructor(JsxElementName).call(this, location);
    this.names = names;
  }
  return ($__createClass)(JsxElementName, {
    transform: function(transformer) {
...
var JsxPlaceholder = function($__super) {
  function JsxPlaceholder(location, expression) {
    $__superConstructor(JsxPlaceholder).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(JsxPlaceholder, {
    transform: function(transformer) {
...
var JsxSpreadAttribute = function($__super) {
  function JsxSpreadAttribute(location, expression) {
    $__superConstructor(JsxSpreadAttribute).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(JsxSpreadAttribute, {
    transform: function(transformer) {
...
var JsxText = function($__super) {
  function JsxText(location, value) {
    $__superConstructor(JsxText).call(this, location);
    this.value = value;
  }
  return ($__createClass)(JsxText, {
    transform: function(transformer) {
...
var LabelledStatement = function($__super) {
  function LabelledStatement(location, name, statement) {
    $__superConstructor(LabelledStatement).call(this, location);
    this.name = name;
    this.statement = statement;
  }
  return ($__createClass)(LabelledStatement, {
    transform: function(transformer) {
...
var LiteralExpression = function($__super) {
  function LiteralExpression(location, literalToken) {
    $__superConstructor(LiteralExpression).call(this, location);
    this.literalToken = literalToken;
  }
  return ($__createClass)(LiteralExpression, {
    transform: function(transformer) {
...
var LiteralPropertyName = function($__super) {
  function LiteralPropertyName(location, literalToken) {
    $__superConstructor(LiteralPropertyName).call(this, location);
    this.literalToken = literalToken;
  }
  return ($__createClass)(LiteralPropertyName, {
    transform: function(transformer) {
...
var MemberExpression = function($__super) {
  function MemberExpression(location, operand, memberName) {
    $__superConstructor(MemberExpression).call(this, location);
    this.operand = operand;
    this.memberName = memberName;
  }
  return ($__createClass)(MemberExpression, {
    transform: function(transformer) {
...
var MemberLookupExpression = function($__super) {
  function MemberLookupExpression(location, operand, memberExpression) {
    $__superConstructor(MemberLookupExpression).call(this, location);
    this.operand = operand;
    this.memberExpression = memberExpression;
  }
  return ($__createClass)(MemberLookupExpression, {
    transform: function(transformer) {
...
var Method = function($__super) {
  function Method(location, isStatic, functionKind, name, parameterList, typeAnnotation, annotations, body, debugName) {
    $__superConstructor(Method).call(this, location);
    this.isStatic = isStatic;
    this.functionKind = functionKind;
    this.name = name;
    this.parameterList = parameterList;
...
var MethodSignature = function($__super) {
  function MethodSignature(location, name, optional, callSignature) {
    $__superConstructor(MethodSignature).call(this, location);
    this.name = name;
    this.optional = optional;
    this.callSignature = callSignature;
  }
  return ($__createClass)(MethodSignature, {
    transform: function(transformer) {
...
var Module = function($__super) {
  function Module(location, scriptItemList, moduleName) {
    $__superConstructor(Module).call(this, location);
    this.scriptItemList = scriptItemList;
    this.moduleName = moduleName;
  }
  return ($__createClass)(Module, {
    transform: function(transformer) {
...
var ModuleSpecifier = function($__super) {
  function ModuleSpecifier(location, token) {
    $__superConstructor(ModuleSpecifier).call(this, location);
    this.token = token;
  }
  return ($__createClass)(ModuleSpecifier, {
    transform: function(transformer) {
...
var NameSpaceExport = function($__super) {
  function NameSpaceExport(location, name) {
    $__superConstructor(NameSpaceExport).call(this, location);
    this.name = name;
  }
  return ($__createClass)(NameSpaceExport, {
    transform: function(transformer) {
...
var NameSpaceImport = function($__super) {
  function NameSpaceImport(location, binding) {
    $__superConstructor(NameSpaceImport).call(this, location);
    this.binding = binding;
  }
  return ($__createClass)(NameSpaceImport, {
    transform: function(transformer) {
...
var NamedExport = function($__super) {
  function NamedExport(location, exportClause, moduleSpecifier) {
    $__superConstructor(NamedExport).call(this, location);
    this.exportClause = exportClause;
    this.moduleSpecifier = moduleSpecifier;
  }
  return ($__createClass)(NamedExport, {
    transform: function(transformer) {
...
var NewExpression = function($__super) {
  function NewExpression(location, operand, args) {
    $__superConstructor(NewExpression).call(this, location);
    this.operand = operand;
    this.args = args;
  }
  return ($__createClass)(NewExpression, {
    transform: function(transformer) {
...
var ObjectLiteral = function($__super) {
  function ObjectLiteral(location, propertyNameAndValues) {
    $__superConstructor(ObjectLiteral).call(this, location);
    this.propertyNameAndValues = propertyNameAndValues;
  }
  return ($__createClass)(ObjectLiteral, {
    transform: function(transformer) {
...
var ObjectPattern = function($__super) {
  function ObjectPattern(location, fields) {
    $__superConstructor(ObjectPattern).call(this, location);
    this.fields = fields;
  }
  return ($__createClass)(ObjectPattern, {
    transform: function(transformer) {
...
var ObjectPatternField = function($__super) {
  function ObjectPatternField(location, name, element) {
    $__superConstructor(ObjectPatternField).call(this, location);
    this.name = name;
    this.element = element;
  }
  return ($__createClass)(ObjectPatternField, {
    transform: function(transformer) {
...
var ObjectType = function($__super) {
  function ObjectType(location, typeMembers) {
    $__superConstructor(ObjectType).call(this, location);
    this.typeMembers = typeMembers;
  }
  return ($__createClass)(ObjectType, {
    transform: function(transformer) {
...
var ParenExpression = function($__super) {
  function ParenExpression(location, expression) {
    $__superConstructor(ParenExpression).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ParenExpression, {
    transform: function(transformer) {
...
var PostfixExpression = function($__super) {
  function PostfixExpression(location, operand, operator) {
    $__superConstructor(PostfixExpression).call(this, location);
    this.operand = operand;
    this.operator = operator;
  }
  return ($__createClass)(PostfixExpression, {
    transform: function(transformer) {
...
var PredefinedType = function($__super) {
  function PredefinedType(location, typeToken) {
    $__superConstructor(PredefinedType).call(this, location);
    this.typeToken = typeToken;
  }
  return ($__createClass)(PredefinedType, {
    transform: function(transformer) {
...
var Script = function($__super) {
  function Script(location, scriptItemList, moduleName) {
    $__superConstructor(Script).call(this, location);
    this.scriptItemList = scriptItemList;
    this.moduleName = moduleName;
  }
  return ($__createClass)(Script, {
    transform: function(transformer) {
...
var PropertyNameAssignment = function($__super) {
  function PropertyNameAssignment(location, name, value) {
    $__superConstructor(PropertyNameAssignment).call(this, location);
    this.name = name;
    this.value = value;
  }
  return ($__createClass)(PropertyNameAssignment, {
    transform: function(transformer) {
...
var PropertyNameShorthand = function($__super) {
  function PropertyNameShorthand(location, name) {
    $__superConstructor(PropertyNameShorthand).call(this, location);
    this.name = name;
  }
  return ($__createClass)(PropertyNameShorthand, {
    transform: function(transformer) {
...
var PropertyVariableDeclaration = function($__super) {
  function PropertyVariableDeclaration(location, isStatic, name, typeAnnotation, annotations, initializer) {
    $__superConstructor(PropertyVariableDeclaration).call(this, location);
    this.isStatic = isStatic;
    this.name = name;
    this.typeAnnotation = typeAnnotation;
    this.annotations = annotations;
  ...
  return ($__createClass)(PropertyVariableDeclaration, {
    transform: function(transformer) {
...
var PropertySignature = function($__super) {
  function PropertySignature(location, name, optional, typeAnnotation) {
    $__superConstructor(PropertySignature).call(this, location);
    this.name = name;
    this.optional = optional;
    this.typeAnnotation = typeAnnotation;
  }
  return ($__createClass)(PropertySignature, {
    transform: function(transformer) {
...
var RestParameter = function($__super) {
  function RestParameter(location, identifier) {
    $__superConstructor(RestParameter).call(this, location);
    this.identifier = identifier;
  }
  return ($__createClass)(RestParameter, {
    transform: function(transformer) {
...
var ReturnStatement = function($__super) {
  function ReturnStatement(location, expression) {
    $__superConstructor(ReturnStatement).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(ReturnStatement, {
    transform: function(transformer) {
...
var SetAccessor = function($__super) {
  function SetAccessor(location, isStatic, name, parameterList, annotations, body) {
    $__superConstructor(SetAccessor).call(this, location);
    this.isStatic = isStatic;
    this.name = name;
    this.parameterList = parameterList;
    this.annotations = annotations;
  ...
  return ($__createClass)(SetAccessor, {
    transform: function(transformer) {
...
var SpreadExpression = function($__super) {
  function SpreadExpression(location, expression) {
    $__superConstructor(SpreadExpression).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(SpreadExpression, {
    transform: function(transformer) {
...
var SpreadPatternElement = function($__super) {
  function SpreadPatternElement(location, lvalue) {
    $__superConstructor(SpreadPatternElement).call(this, location);
    this.lvalue = lvalue;
  }
  return ($__createClass)(SpreadPatternElement, {
    transform: function(transformer) {
...
var SuperExpression = function($__super) {
  function SuperExpression(location) {
    $__superConstructor(SuperExpression).call(this, location);
  }
  return ($__createClass)(SuperExpression, {
    transform: function(transformer) {
...
var SwitchStatement = function($__super) {
  function SwitchStatement(location, expression, caseClauses) {
    $__superConstructor(SwitchStatement).call(this, location);
    this.expression = expression;
    this.caseClauses = caseClauses;
  }
  return ($__createClass)(SwitchStatement, {
    transform: function(transformer) {
...
var SyntaxErrorTree = function($__super) {
  function SyntaxErrorTree(location, nextToken, message) {
    $__superConstructor(SyntaxErrorTree).call(this, location);
    this.nextToken = nextToken;
    this.message = message;
  }
  return ($__createClass)(SyntaxErrorTree, {
    transform: function(transformer) {
...
var TemplateLiteralExpression = function($__super) {
  function TemplateLiteralExpression(location, operand, elements) {
    $__superConstructor(TemplateLiteralExpression).call(this, location);
    this.operand = operand;
    this.elements = elements;
  }
  return ($__createClass)(TemplateLiteralExpression, {
    transform: function(transformer) {
...
var TemplateLiteralPortion = function($__super) {
  function TemplateLiteralPortion(location, value) {
    $__superConstructor(TemplateLiteralPortion).call(this, location);
    this.value = value;
  }
  return ($__createClass)(TemplateLiteralPortion, {
    transform: function(transformer) {
...
var TemplateSubstitution = function($__super) {
  function TemplateSubstitution(location, expression) {
    $__superConstructor(TemplateSubstitution).call(this, location);
    this.expression = expression;
  }
  return ($__createClass)(TemplateSubstitution, {
    transform: function(transformer) {
...
var ThisExpression = function($__super) {
  function ThisExpression(location) {
    $__superConstructor(ThisExpression).call(this, location);
  }
  return ($__createClass)(ThisExpression, {
    transform: function(transformer) {
...
var ThrowStatement = function($__super) {
  function ThrowStatement(location, value) {
    $__superConstructor(ThrowStatement).call(this, location);
    this.value = value;
  }
  return ($__createClass)(ThrowStatement, {
    transform: function(transformer) {
...
var TryStatement = function($__super) {
  function TryStatement(location, body, catchBlock, finallyBlock) {
    $__superConstructor(TryStatement).call(this, location);
    this.body = body;
    this.catchBlock = catchBlock;
    this.finallyBlock = finallyBlock;
  }
  return ($__createClass)(TryStatement, {
    transform: function(transformer) {
...
var TypeAliasDeclaration = function($__super) {
  function TypeAliasDeclaration(location, name, value) {
    $__superConstructor(TypeAliasDeclaration).call(this, location);
    this.name = name;
    this.value = value;
  }
  return ($__createClass)(TypeAliasDeclaration, {
    transform: function(transformer) {
...
var TypeArguments = function($__super) {
  function TypeArguments(location, args) {
    $__superConstructor(TypeArguments).call(this, location);
    this.args = args;
  }
  return ($__createClass)(TypeArguments, {
    transform: function(transformer) {
...
var TypeName = function($__super) {
  function TypeName(location, moduleName, name) {
    $__superConstructor(TypeName).call(this, location);
    this.moduleName = moduleName;
    this.name = name;
  }
  return ($__createClass)(TypeName, {
    transform: function(transformer) {
...
var TypeParameter = function($__super) {
  function TypeParameter(location, identifierToken, extendsType) {
    $__superConstructor(TypeParameter).call(this, location);
    this.identifierToken = identifierToken;
    this.extendsType = extendsType;
  }
  return ($__createClass)(TypeParameter, {
    transform: function(transformer) {
...
var TypeParameters = function($__super) {
  function TypeParameters(location, parameters) {
    $__superConstructor(TypeParameters).call(this, location);
    this.parameters = parameters;
  }
  return ($__createClass)(TypeParameters, {
    transform: function(transformer) {
...
var TypeReference = function($__super) {
  function TypeReference(location, typeName, args) {
    $__superConstructor(TypeReference).call(this, location);
    this.typeName = typeName;
    this.args = args;
  }
  return ($__createClass)(TypeReference, {
    transform: function(transformer) {
...
var UnaryExpression = function($__super) {
  function UnaryExpression(location, operator, operand) {
    $__superConstructor(UnaryExpression).call(this, location);
    this.operator = operator;
    this.operand = operand;
  }
  return ($__createClass)(UnaryExpression, {
    transform: function(transformer) {
...
var UnionType = function($__super) {
  function UnionType(location, types) {
    $__superConstructor(UnionType).call(this, location);
    this.types = types;
  }
  return ($__createClass)(UnionType, {
    transform: function(transformer) {
...
var VariableDeclaration = function($__super) {
  function VariableDeclaration(location, lvalue, typeAnnotation, initializer) {
    $__superConstructor(VariableDeclaration).call(this, location);
    this.lvalue = lvalue;
    this.typeAnnotation = typeAnnotation;
    this.initializer = initializer;
  }
  return ($__createClass)(VariableDeclaration, {
    transform: function(transformer) {
...
var VariableDeclarationList = function($__super) {
  function VariableDeclarationList(location, declarationType, declarations) {
    $__superConstructor(VariableDeclarationList).call(this, location);
    this.declarationType = declarationType;
    this.declarations = declarations;
  }
  return ($__createClass)(VariableDeclarationList, {
    transform: function(transformer) {
...
var VariableStatement = function($__super) {
  function VariableStatement(location, declarations) {
    $__superConstructor(VariableStatement).call(this, location);
    this.declarations = declarations;
  }
  return ($__createClass)(VariableStatement, {
    transform: function(transformer) {
...
var WhileStatement = function($__super) {
  function WhileStatement(location, condition, body) {
    $__superConstructor(WhileStatement).call(this, location);
    this.condition = condition;
    this.body = body;
  }
  return ($__createClass)(WhileStatement, {
    transform: function(transformer) {
...
var WithStatement = function($__super) {
  function WithStatement(location, expression, body) {
    $__superConstructor(WithStatement).call(this, location);
    this.expression = expression;
    this.body = body;
  }
  return ($__createClass)(WithStatement, {
    transform: function(transformer) {
...
var YieldExpression = function($__super) {
  function YieldExpression(location, expression, isYieldFor) {
    $__superConstructor(YieldExpression).call(this, location);
    this.expression = expression;
    this.isYieldFor = isYieldFor;
  }
  return ($__createClass)(YieldExpression, {
    transform: function(transformer) {
